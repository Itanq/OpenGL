...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// 物体材质属性设置
		Uint materialAmbientLoc = glGetUniformLocation(containerShader.Program, "material.ambient");
		Uint materialDiffuseLoc = glGetUniformLocation(containerShader.Program, "material.diffuse");
		Uint materialSpecularLoc = glGetUniformLocation(containerShader.Program, "material.specular");
		...
		Uint lightColorLoc = glGetUniformLocation(lampShader.Program, "lightColor");
