...
int main()
{
	...
	GLuint skyTexture = loadSkyBox(faces);
	...
	while(!glfwWindowShouldClose(window))
    {
		...
		skyShader.Use();
		glm::mat4 skyView = glm::mat4(glm::mat3(camera.GetViewMatrix())); // È¥³ýÆ½ÒÆ²Ù×÷
		glm::mat4 skyProjection = glm::perspective(camera.Zoom, (GLfloat)WIDTH / (GLfloat)HEIGHT, 0.1f, 100.0f);
		glUniformMatrix4fv(glGetUniformLocation(skyShader.Program, "view"), 1, GL_FALSE, glm::value_ptr(skyView));
		glUniformMatrix4fv(glGetUniformLocation(skyShader.Program, "projection"), 1, GL_FALSE, glm::value_ptr(skyProjection));
